...
use App\Repositories\Interfaces\ProductCatalogueReponsitoryInterface;
 ...
 */
class ProductCatalogueReponsitory extends BaseRepository implements ProductCatalogueReponsitoryInterface
{
    protected $model;
