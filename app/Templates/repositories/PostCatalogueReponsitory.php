...
use App\Repositories\Interfaces\{$class}CatalogueReponsitoryInterface;
 ...
 */
class {$class}CatalogueReponsitory extends BaseRepository implements {$class}CatalogueReponsitoryInterface
{
    protected $model;
