...
class {$class}Service extends BaseService implements {$class}ServiceInterface
{
    ...
    public function paginate($request, $languageId){
        ...
        ${module}s = $this->{module}Reponsitory->pagination(
            $this->paginateSelect(), 
            $condition, 
            $perPage,
            $paginationConfig,  
    ...
    public function update($id, $request, $languageId){
        DB::beginTransaction();
        try{
            ${module} = $this->{module}Reponsitory->findById($id);
    ...
    public function destroy($id){
        DB::beginTransaction();
        try{
            ${module} = $this->{module}Reponsitory->delete($id);
    ...
    private function create{$class}($request){
        ...
        ${module} = $this->{module}Reponsitory->create($payload);
        return ${module};
    }
    ...
    private function upload{$class}(${module}, $request){
        $payload = $request->only($this->payload());
        $payload['album'] = $this->formatAlbum($request);
        return $this->{module}Reponsitory->update(${module}->id, $payload);
    }
    ...
    private function updateLanguageFor{$class}(${module}, $request, $languageId){
        ...
        return $this->{module}Reponsitory->createPivot(${module}, $payload, 'languages');
    }
    ...
    public function updateStatus($post = []){
        ...
        try{
            ...
            $post = $this->{module}Reponsitory->update($post['modelId'], $payload);
    ...
    public function updateStatusAll($post){
        ...
        try{
            ...
            $flag = $this->{module}Reponsitory->updateByWhereIn('id', $post['id'], $payload);
