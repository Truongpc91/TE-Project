    ...
    <div class="header-upper">
        <div class="uk-container uk-container-center">
            <div class="uk-flex uk-flex-middle uk-flex-space-between">
                <div class="sitelink">
                    @if (isset($menus['sidebar-menu']))
                        <ul class="uk-list uk-clearfix uk-flex uk-flex-middle">
                            @foreach ($menus['sidebar-menu'] as $key => $val)
                                @php
                                ...
                                @endphp
                                <li><a href="{{ $canonical }}" title="">{{ $name }}</a></li>
                            @endforeach
                        </ul>
                    @endif
                </div>
                ...
                <div class="header-widget">
                    <div class="uk-flex uk-flex-middle">
                        <div class="call-us">Cần hỗ trợ? Gọi cho chúng tôi: <a href="tel:098 236 5824"
                                        ...
                                        <defs>
                                            <clipPath>
                                                <rect width="24" height="24" fill="white"
                                                    transform="translate(0.775391 0.366516)"></rect>
                                            </clipPath>
                                        </defs>
                                    </svg>
                                    <span class="number">0</span>
                            ...
                            <a href="" title="" class="uk-flex uk-flex-bottom">
                                <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25"
                                    ...
                                    <defs>
                                        <clipPath>
                                            <rect width="24" height="24" fill="white"
                                                transform="translate(0.444336 0.366516)"></rect>
                                        </clipPath>
                                    </defs>
                                </svg>
