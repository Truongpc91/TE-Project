...
<form action="{{ route('admin.user_catalogue.destroy', $user_catalogue) }}" method="POST" class="box" enctype="multipart/form-data">
    @csrf
    @method('DELETE')
                            ...
                            <div class="col-lg-6">
                                <div class="form-row">
                                    ...
                                    <input type="text" class="form-control" name="name" placeholder=""
                                        autocomplete="off" value="{{ old('name', $user_catalogue->name ?? '') }}" readonly>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-row">
                                    ...
                                    <input type="text" class="form-control" name="description" placeholder=""
                                        autocomplete="off" value="{{ old('description', $user_catalogue->description ?? '') }}" readonly>
                                </div>
                            </div>
