...
<form action="{{ route('admin.promotion.destroy', $promotion->id) }}" method="POST" class="box" enctype="multipart/form-data">
    @csrf
    @method('DELETE')
            ...
            <div class="col-lg-5">
                <div class="panel-head">
                    ...
                    <div class="panel-description">
                        <p>Bạn đang muốn xóa Khuyến mãi là : <strong>{{ $promotion->name }}</strong></p>
                ...
                <div class="ibox">
                    <div class="ibox-content">
                        <div class="row mb15">
                            <div class="col-lg-12">
                                <div class="form-row">
                                    <label for="" class="control-label text-right">Tên khuyến mãi
                                        <span class="text-danger">(*)</span>
                                    </label>
                                    <input type="text" class="form-control" name="email" placeholder=""
                                        autocomplete="off" value="{{ old('email', $promotion->name ?? '') }}" readonly>
                                </div>
                            </div>
                        </div>
                    </div>
