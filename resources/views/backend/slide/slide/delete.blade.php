...
<form action="{{ route('admin.slide.destroy', $slide) }}" method="POST" class="box" enctype="multipart/form-data">
    @csrf
    @method('DELETE')
            ...
            <div class="col-lg-5">
                <div class="panel-head">
                    ...
                    <div class="panel-description">
                        <p>Bạn đang muốn xóa thành viên có Email là : <strong>{{ $slide->email }}</strong></p>
                            ...
                            <div class="col-lg-6">
                                <div class="form-row">
                                    ...
                                    <input type="text" class="form-control" name="email" placeholder=""
                                        autocomplete="off" value="{{ old('email', $slide->email ?? '') }}" readonly>
                                </div>
                            </div>
                        </div>
                    </div>
