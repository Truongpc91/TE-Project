        ...
        @if(isset($products) && is_object($products))
            ...
            <tr id="{{ $product->id }}">
                    ...
                    <div class="">
                        ...
                        <div class="main-info">
                            ...
                            <div class="catalogue">
                                ...
                                <a href="{{ route('admin.product.index', ['product_catalogue_id' => $val->id]) }}" title="">{{ $cat->name }}</a>
                                @endforeach
                                @endforeach
                            </div>
                ...
                <td class="text-center"> 
                    <a href="{{ route('admin.product.edit', $product) }}" class="btn btn-success"><i class="fa fa-edit"></i></a>
                    <a href="{{ route('admin.product.delete', $product) }}" class="btn btn-danger"><i class="fa fa-trash"></i></a>
                </td>
            </tr>
            @endforeach
        @endif
