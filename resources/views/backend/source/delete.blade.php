...
<form action="{{ route('admin.source.destroy', $source->id) }}" method="POST" class="box" enctype="multipart/form-data">
    @csrf
    @method('DELETE')
            ...
            <div class="col-lg-5">
                <div class="panel-head">
                    ...
                    <div class="panel-description">
                        <p>Bạn đang muốn xóa Widget là : <strong>{{ $source->name }}</strong></p>
                            ...
                            <div class="col-lg-12">
                                <div class="form-row">
                                    ...
                                    <input type="text" class="form-control" name="email" placeholder=""
                                        autocomplete="off" value="{{ old('email', $source->name ?? '') }}" readonly>
                                </div>
                            </div>
                        </div>
                    </div>
