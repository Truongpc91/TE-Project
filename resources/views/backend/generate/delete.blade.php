...
<form action="{{ route('admin.generates.destroy', $generate->id) }}" method="post" class="box">
    @csrf
    @method('DELETE')
            ...
            <div class="col-lg-5">
                <div class="panel-head">
                    ...
                    <div class="panel-description">
                        <p>Bạn đang muốn xóa bản ghi có tên là: <span class="text-danger">{{ $generate->name }}</span></p>
