        ...
        @if(isset($generates) && is_object($generates))
            ...
            <tr >
                ...
                <td class="text-center"> 
                    <a href="{{ route('admin.generates.edit', $generate->id) }}" class="btn btn-success"><i class="fa fa-edit"></i></a>
                    <a href="{{ route('admin.generates.delete', $generate->id) }}" class="btn btn-danger"><i class="fa fa-trash"></i></a>
                </td>
            </tr>
            @endforeach
        @endif
