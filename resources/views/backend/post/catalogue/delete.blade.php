...
<form action="{{ route('admin.post_catalogue.destroy', $post_catalogue) }}" method="POST" class="box" enctype="multipart/form-data">
    @csrf
    @method('DELETE')
            ...
            <div class="col-lg-5">
                <div class="panel-head">
                    ...
                    <div class="panel-description">
                        <p>Xóa ngôn ngữ : <span class="text-danger">{{ $post_catalogue->name }}</span></p>
                            ...
                            <div class="col-lg-6">
                                <div class="form-row">
                                    ...
                                    <input type="text" class="form-control" name="name" placeholder=""
                                        autocomplete="off" value="{{ old('name', $post_catalogue->name ?? '') }}" readonly>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-row">
                                    ...
                                    <input type="text" class="form-control" name="canonical" placeholder=""
                                        autocomplete="off" value="{{ old('description', $post_catalogue->canonical ?? '') }}" readonly>
                                </div>
                            </div>
                        </div>
                    </div>
